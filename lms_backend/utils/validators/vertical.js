// utils/validators/vertical.js
// ============================================================================
// Input validators for the Vertical entity.
// Each helper returns:
...
const validateDisplayOrder = (value) => {
    ...
    // Accept stringified integers from JSON (Express does not coerce).
...
const validateVerticalId = (value, fieldName = "id") => {
